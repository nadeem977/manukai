...
const Addsurveillance = ({ openmo }) => {
  ...
  const [defaultval, setdefaultval] = React.useState(
    "'protest' , 'demonstration' , 'rally' , 'activism' , 'disobedience' , 'public assembly' ,  'march' , 'strike' "
  );
  ...
  return (
    <>
      <div>
        ...
        >
          <div className="shdossye trnd absolute top-[50%] left-[50%] w-full max-w-[421px] rounded-lg border-[1px] border-[#12A5C6]">
            <div className="w-full border-b-[1px] border-[#B3B3B3] p-2 flex items-center justify-between">
              <h1 className="tracking-widest text-[#12A5C6] text-[18px] font-bold">
                Add Task To{" "}
                <i className="bi bi-eye font-bold text-[17pxpx] text-[#12A5C6]"></i>
                Surveillance
              </h1>
            ...
            <div className="p-2">
              <div className=" mt-2 pr-10 font-medium grid grid-cols-1 sm:grid-cols-3 gap-2">
                <button
                  className={`border-[1px] text-[12px] justify-center border-[#4ED2EF80] 
                    rounded px-2 p-1 flex items-center gap-2 ${
                      active1 === "1" ? "bg-[#12A5C6] text-black" : ""
                    }`}
                ...
                <button
                  className={`border-[1px] text-[12px] justify-center border-[#4ED2EF80] rounded px-2 p-1 flex items-center gap-1
                               ${
                                 active1 === "3"
                                   ? "bg-[#12A5C6] text-black"
                                   : ""
                               }`}
                  onClick={() => setActive1("3")}
                >
              ...
              <div className="text-[15px] mt-3">
                ...
                <textarea
                  className="w-full resize-none border-[1px] border-[#4ED2EF80] 
                p-1 rounded-lg outline-none text-[#4ED2EF80] min-h-[72px] bg-transparent"
                  value={defaultval}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center">
                      <CustomCheckbox
                        style={{ color: "#C5F5FF", width: "20px", padding: 0 }}
                        id="f1"
                        defaultChecked
                      />
                      <label
                        htmlFor="f1"
                        className="text-[#3CCF6E] cursor-pointer"
                      >
                        Ok
                      </label>
                    </div>
                    <div className="flex items-center ">
                      ...
                      <label
                        htmlFor="f2"
                        className="text-[#F7D240] cursor-pointer"
                      >
                        WARN
                      </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      <label
                        htmlFor="f3"
                        className="text-[#D23123] cursor-pointer"
                      >
                        CRIT
                      </label>
                    </div>
              ...
              <div className="flex items-center justify-end gap-3">
                <button className="px-2 py-[2px] bg-[#6F6F6F] rounded text-[white]">
                  Cancel
                </button>
                <button
                  className="px-2 py-[2px] bg-[#009C2C] rounded text-[white] w-fit h-[25px] text-[15px] gap-1 flex items-center"
                  onClick={handleClose}
                >
                  <i className="bi bi-check2 text-[18px]"></i> Go To
                  Surveillance
                </button>
              </div>
            </div>
